...
namespace CaronteFX
{
    ...
    public class CarAnimationBaker
    {
        ...
        //--------------------------------DATA MEMBERS---------------------------------------
        //-----------------------------------------------------------------------------------
        private const int binaryVersion_ = 9;

        private CarManager manager_;
        private CarEntityManager entityManager_;
        private CarPlayer player_;

        private CarMeshCombiner skinnedMeshCombiner_;
        private CarMeshCombiner frameMeshCombiner_;

        private UnityEngine.Object meshesPrefab_;
        private String assetsPath_;
        private String fxName_;

        private Dictionary<uint, string> idBodyToRelativePath_;
        private Dictionary<uint, string[]> idBodyToBonesRelativePaths_;
        private Dictionary<uint, GameObject> idBodyToBakedGO_;
        private Dictionary<uint, CarGOKeyframe> idBodyToGOKeyframe_;
        private Dictionary<uint, Vector2> idBodyToVisibilityInterval_;

        private Dictionary<Mesh, Mesh> originalMeshToBakedMesh_;

        private List<uint> listIdBodyTmp_;
        private List<GameObject> listGOTmp_;

        private List<Transform> listTransformTmp_;
        private List<BoneWeight> listBoneWeightTmp_;
        private List<Matrix4x4> listBindPoseTmp_;

        private HashSet<uint> setBoneBodies_;
        private HashSet<uint> setVisibleBodies_;

        private MeshComplex meshComplexForUpdate_ = new MeshComplex();

        private int frame_;
        private int bakingFrame_;

        private int frameCount_;

        private int frameStart_ = -1;
        private int frameEnd_ = -1;

        private float visibilityShift_ = 0;
        private float visibilityRangeMin_ = 0;
        private float visibilityRangeMax_ = 0;
