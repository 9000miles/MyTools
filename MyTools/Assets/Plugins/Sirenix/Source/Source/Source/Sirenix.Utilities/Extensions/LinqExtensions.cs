...
namespace Sirenix.Utilities
{
    ...
    public static class LinqExtensions
    {
        ...
        public static IEnumerable<T> AppendLinqExtensions<T>(this IEnumerable<T> source, Func<T> append)
        {
            foreach (var item in source)
            {
                yield return item;
        ...
        public static IEnumerable<T> AppendLinqExtensions<T>(this IEnumerable<T> source, T append)
        {
            foreach (var item in source)
            {
                yield return item;
