...
#pragma warning restore 0649
        ...
        private void DrawRightMenu()
        {
            ...
            this.rightMenuScrollPos = EditorGUILayout.BeginScrollView(this.rightMenuScrollPos, expand);
            {
                ...
                GUILayout.BeginHorizontal(expand);
                {
                    ...
                    {
                        var prevLabelWidth = GUIHelper.ActualLabelWidth;
                        ...
                        if (this.activeMenu != null)
                        {
                            GUILayout.BeginHorizontal();
                            GUILayout.Space(-3);
                            GUILayout.BeginVertical(SirenixGUIStyles.OdinEditorWrapper);
                            GUILayout.Space(1);
        ...
        {
            EditorGlobalConfigAttribute.OpenWindow<SirenixGlobalConfigAttribute>("Sirenix Preferences");
        }
        ...
        //    private static string ItemsToString<TValue>(IEnumerable<TValue> items, string separator)
        //    {
