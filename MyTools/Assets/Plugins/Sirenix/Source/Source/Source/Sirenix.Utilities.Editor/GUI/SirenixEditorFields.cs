...
namespace Sirenix.Utilities.Editor
{
    ...
    public static class SirenixEditorFields
    {
        ...
        public static Vector2 Vector2Field(Rect rect, GUIContent label, Vector2 value)
        {
            ...
            value.x = FloatField(rect.Split(0, 2), showLabels ? "X" : null, value.x);
            value.y = FloatField(rect.Split(1, 2).HorizontalPadding(4, 0), showLabels ? "Y" : null, value.y);
        ...
        public static Vector3 Vector3Field(Rect rect, GUIContent label, Vector3 value)
        {
            ...
            // Field
            GUIHelper.PushLabelWidth(15);
            value.x = FloatField(rect.Split(0, 3), showLabels ? "X" : null, value.x);
            value.y = FloatField(rect.Split(1, 3).HorizontalPadding(4, 0), showLabels ? "Y" : null, value.y);
            value.z = FloatField(rect.Split(2, 3).HorizontalPadding(4, 0), showLabels ? "Z" : null, value.z);
            GUIHelper.PopLabelWidth();
        ...
        public static Vector4 Vector4Field(Rect rect, GUIContent label, Vector4 value)
        {
            ...
            // Field
            GUIHelper.PushLabelWidth(15);
            value.x = FloatField(rect.Split(0, 4), showLabels ? "X" : null, value.x);
            value.y = FloatField(rect.Split(1, 4).HorizontalPadding(4, 0), showLabels ? "Y" : null, value.y);
            value.z = FloatField(rect.Split(2, 4).HorizontalPadding(4, 0), showLabels ? "Z" : null, value.z);
            value.w = FloatField(rect.Split(3, 4).HorizontalPadding(4, 0), showLabels ? "W" : null, value.w);
            GUIHelper.PopLabelWidth();
        ...
        public static Enum EnumDropdown(Rect rect, GUIContent label, Enum selected, GUIStyle style)
        {
            ...
            if (!type.IsDefined<FlagsAttribute>())
            {
                if (GUI.Button(buttonPosition, display, style))
                {
                    ...
                    {
                        int localI = i;
                        menu.AddItem(new GUIContent(names[i]), selected == (Enum)(object)valuesArray.GetValue(i), () =>
                        {
        ...
        private static void DrawOpenInspector(Rect rect, UnityEngine.Object obj)
        {
