...
namespace Sirenix.Utilities.Editor
{
    ...
    public static class SirenixEditorGUI
    {
        ...
        private static float defaultFadeGroupDuration = 0.2f;
        private static float tabPageSlideAnimationDuration = 0.2f;
        ...
        [Obsolete("This method is going to be removed. Draw a button manually, and call GUIHelper.OpenInspectorWindow(obj) instead.", false)]
        ...
        {
            if (GUILayout.RepeatButton(icon.ActiveGUIContent, SirenixGUIStyles.None, GUILayoutOptions.Width(width).Height(height)))
            {
                GUI.FocusControl(null);
                GUIHelper.RequestRepaint();
                return true;
        ...
        {
            if (GUILayout.Button(GUIContent.none, SirenixGUIStyles.ToolbarButton, GUILayoutOptions.Width(currentDrawingToolbarHeight).Height(currentDrawingToolbarHeight)))
            {
                GUI.FocusControl(null);
                GUIHelper.RequestRepaint();
                return true;
