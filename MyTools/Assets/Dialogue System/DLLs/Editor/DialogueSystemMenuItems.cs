...
namespace PixelCrushers.DialogueSystem
{
    ...
    static public class DialogueSystemMenuItems
    {
		...
		[MenuItem("Window/Dialogue System/*Academic License*", false, -10)]
		static public void HelpAcademicLicense() {

		}
		
		[MenuItem("Window/Dialogue System/*Academic License*", true, -10)]
		...
		[MenuItem("Window/Dialogue System/*Evaluation Version*", false, 98)]
		static public void HelpEvaluationVersion() {
			
		}
		
		[MenuItem("Window/Dialogue System/*Evaluation Version*", true, 98)]
		static bool ValidateHelpEvaluationVersion() {
			return false;
		}	

		[MenuItem("Window/Dialogue System/BUY NOW...", false, 99)]
        ...
        [MenuItem("Window/Dialogue System/Help/About", false, 0)]
        static public void HelpAbout()
        {
            ShowAboutWindow();
        }

        [MenuItem("Window/Dialogue System/Help/Manual", false, 1)]
        ...
        [MenuItem("Window/Dialogue System/Extras...", false, 17)]
        ...
        public static string GetVersion()
        {
            ...
            try
            {
                StreamReader streamReader = new StreamReader(Application.dataPath + "/Dialogue System/_README.txt");
