...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class ChatMapperConverter : EditorWindow
    {
        ...
        //--- Moved to ChatMapperToDialogueDatabase to be shared by runtime converter:
        //private void FixConversationsLinkedToFirstEntry(DialogueDatabase database)
        //{
        ...
        //                if (prefs.resetNodePositions) entry.canvasRect = new Rect(0, 0, DialogueEntry.CanvasRectWidth, DialogueEntry.CanvasRectHeight);
        ...
        //            if (entry.Sequence != null && !entry.Sequence.Contains(audioWaitCommand))
        //            {
