...
namespace PixelCrushers.DialogueSystem.DialogueEditor
{
    ...
    public partial class DialogueEditorWindow
    {
        ...
        {
            if (!EditorUtility.DisplayDialog("Reorder IDs", "Are you sure you want to reorder dialogue entry ID numbers in this conversation?", "OK", "Cancel")) return;
        ...
        private void ReorderIDsAllConversations()
        {
            ...
            {
                ReorderIDsInConversation(conversation);
            }
            ResetDialogueTreeSection();
        }
