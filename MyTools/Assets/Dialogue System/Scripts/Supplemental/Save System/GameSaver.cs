    ...
    public class GameSaver : MonoBehaviour
    {
        ...
        public void RestartGame()
        {
            ...
            else
            {
                ...
                {
                    Tools.LoadLevel(0); //---Was: Application.LoadLevel(0);
                }
                else
                {
                    Tools.LoadLevel(startingLevel); //---Was: Application.LoadLevel(startingLevel);
                }
        ...
        /// game to the newly-loaded level. Only observed in Unity 4.x to 5.2.
        /// </summary>
        /// <param name='level'>
        /// Level (not used).
        /// </param>
