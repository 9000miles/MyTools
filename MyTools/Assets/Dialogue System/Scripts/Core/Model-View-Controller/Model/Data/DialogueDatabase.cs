...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class DialogueDatabase : ScriptableObject
    {
        ...
        //{
        //    new EmphasisSetting(Color.white, false, false, false),
        //    new EmphasisSetting(Color.red, false, false, false),
        //    new EmphasisSetting(Color.green, false, false, false),
        //    new EmphasisSetting(Color.blue, false, false, false)
        //};
        ...
        private void AddEmphasisSettings(EmphasisSetting[] newEmphasisSettings)
        {
            ...
            {
                for (int i = 0; i < NumEmphasisSettings; i++)
                {
            ...
            switch (entrytagFormat)
            {
                ...
                case EntrytagFormat.ActorName_ConversationTitle_EntryDescriptor:
                    ...
                    var entryDesc = !string.IsNullOrEmpty(entry.Title) ? entry.Title
                        : (!string.IsNullOrEmpty(entry.MenuText) ? entry.MenuText : entry.id.ToString());
