...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class FormattedText
    {
        ...
        /// <summary>
        /// Extracts a [position #] tag from a string. Removes all position tags and returns the value of the last one.
        /// </summary>
        /// <returns>
        /// The position number.
        /// </returns>
        ...
        private static int ExtractPositionTag(ref string text)
        {
            ...
            if (text.Contains("[position "))
            {
                ...
                {
                    string positionString = match.Value.Substring(10, 1); // Remove "[position " and "]"
