...
namespace PixelCrushers.DialogueSystem {
	...
	public static class SequencerTools {
		...
		public static Transform GetSubject(string specifier, Transform speaker, Transform listener, Transform defaultSubject = null) {
			...
			} else if (string.Compare(specifier, "speaker", System.StringComparison.OrdinalIgnoreCase) == 0) {
				return speaker;
			} else if (string.Compare(specifier, "listener", System.StringComparison.OrdinalIgnoreCase) == 0) {
				return listener;
			} else {
