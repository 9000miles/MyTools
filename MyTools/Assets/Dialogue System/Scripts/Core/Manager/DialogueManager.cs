...
namespace PixelCrushers.DialogueSystem
{
    ...
    public static class DialogueManager
    {
        ...
        {
            get { return Instance.allowSimultaneousConversations; }
        }
        ...
        {
            get { return Instance.GetInputButtonDown; }
        ...
        {
            if (Instance != null) Instance.BroadcastMessage("UpdateTracker", SendMessageOptions.DontRequireReceiver);
        }
